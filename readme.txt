...
-----------------------------------------------------------------------------------------------------------
***** IF YOU HAVE older version yt-dlp (CLI or pip) - you NEED REMOVE ALL, AND INSTALL MASTER VERSION *****

python3 -m pip install --upgrade --force-reinstall git+https://github.com/yt-dlp/yt-dlp.git@master
